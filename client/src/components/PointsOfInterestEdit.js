        ...
        <UserForm>
          ...
          <div>
            ...
            <TextSelect
              ...
              name="region"
              id="region"
              value={modifiedUser.region ? modifiedUser.region : ""} // Use modifiedUser instead of user
          ...
          <div>
            ...
            <TextSelect
              ...
              name="agent"
              id="agent"
              value={modifiedUser.agent ? modifiedUser.agent._id : ""} // Use modifiedUser instead of user
              onChange={handleSelectChange}
            >
              {regions &&
                agentUserData.map((usr) =>
                  usr.role === "agent" ? (
                    <option key={usr._id} value={usr.name}>
                      {usr.name}
                    </option>
                  ) : (
                    ""
